                ...
                <div class="w-lg-600px p-10 p-lg-15 mx-auto">
                    <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework login_form" novalidate="novalidate" id="kt_sign_in_form" action="#">
                        <div class="text-left mb-10">
                            ...
                            <h1 class="text-dark "><span class="blue">Create New Password</span></h1>
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            <div class="p-rel"><input class="form-control form-control-lg form-control-solid" placeholder="Create New Password" type="password" name="password" autocomplete="off">
                                <div class="p-abs">
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            <div class="p-rel"><input class="form-control form-control-lg form-control-solid" placeholder="Confirm New Password" type="password" name="password" autocomplete="off">
                                <div class="p-abs">
                                    <i class="fa-solid fa-lock"></i>
                                </div>
                            </div>
